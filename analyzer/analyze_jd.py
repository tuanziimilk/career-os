...
⚠️ 下面这段是**脱敏过的示例**，不是真实 JD。改这个模板时别把真采集的 JD 粘进来 ——
   这个文件进版本库，而 data/ 和 reports/ 不进。2026-09-15 就是这么漏过一条的。
可选元信息（写在每条开头，不写也行）：
    #公司: 示例科技（Demo）
    #岗位: AI客服产品经理
    #来源: BOSS
...
AI客服产品经理 25-40K·15薪 上海 3-5年 本科
示例科技正在搭建面向巴西、墨西哥市场的 AI 智能客服体系，覆盖葡萄牙语/西班牙语双语场景，
